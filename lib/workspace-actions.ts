    ...
    try {
        ...
        await directusAdmin.request(
            createItems("order_statuses", [
                ...
                { workspace_id: workspaceId, name: "En destino", value: "en_destino", color: "#0891B2", sort: 5 },
                { workspace_id: workspaceId, name: "Entregado", value: "entregado", color: "#10B981", sort: 6 },
                { workspace_id: workspaceId, name: "Cancelado", value: "cancelado", color: "#EF4444", sort: 7 },
            ])
        );
